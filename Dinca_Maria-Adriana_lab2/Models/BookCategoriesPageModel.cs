...
namespace Dinca_Maria_Adriana_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Dinca_Maria_Adriana_lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Dinca_Maria_Adriana_lab2Context context,
