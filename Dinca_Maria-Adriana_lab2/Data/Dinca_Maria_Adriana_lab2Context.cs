...
namespace Dinca_Maria_Adriana_lab2.Data
{
    public class Dinca_Maria_Adriana_lab2Context : DbContext
    {
        ...
        public DbSet<Dinca_Maria_Adriana_lab2.Models.Category> Category { get; set; }

        public DbSet<Dinca_Maria_Adriana_lab2.Models.Member> Member { get; set; }

        public DbSet<Dinca_Maria_Adriana_lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
